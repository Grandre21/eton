...
⚠️ **Scritto dal capo della notte fra il 19 e il 20 settembre 2026**, che ha trovato la chiusura
non integrata e l'ha portata a termine. Il rapporto sta in `handoff/CHIUSURA.md` e porta
`COPERTURA: 27 clausole — coperte 24 · scoperte 1 · rinviate 2` e `COMBINATO: 4 rilievi`.

**La chiusura è avvenuta in due tempi, e va detto perché è la lezione operativa del ciclo.** La
sessione di chiusura ha lavorato in un worktree senza committare; il capo l'ha creduta morta e ha
integrato il suo albero sporco; **lei era viva**, e nove minuti dopo ha pushato il completamento
del §3 da un **secondo worktree con un nome diverso dal primo**. Entrambi i lavori sono su `main`
(`af2daf6` e `920c8fe`). Il segnale che distingue «morta a metà» da «sta scrivendo adesso» non è
strutturale ma **temporale**: albero pulito, più minuti di silenzio, più tutto pushato.

Il goal successivo — «tutto ciò che rimane da chiudere» — ha un piano proprio in
`handoff/PIANO.md`. Questo file è archiviato.
